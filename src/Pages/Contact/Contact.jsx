...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_hr9zzn9', 'template_3k9ik03', form.current, '7cwwGCFl01Fl6TwZq')
        .then((result) => {
            toast.success('Your message sent to Rabbi');
            form.current.reset();
  ...
  return (
    <div>
      ...
      <div>
        ...
        className="text-6xl text-center font-bold mt-6">Md. Fazle Rabbi</h2>
        ...
        <div>
           ...
           <div className='flex gap-4 justify-center items-center'>
           <FaPhone></FaPhone>
          <span className='mt-2 flex text-xl'>+8801311669188</span>
           </div>
          </div>
        </div>
          ...
          <div>
           ...
           <FaGithub></FaGithub>
          <span className='mt-2 flex text-xl'>github.com/fazlera</span>
           </div>
          </div>
        <div>
        <div>
           ...
           <div className='flex gap-4 justify-center items-center'>
           <FaMessage></FaMessage>
          <span className='mt-2 flex text-md md:text-xl'>mdfazlerabbi116691@gmail.com</span>
           </div>
          </div>
        </div>
