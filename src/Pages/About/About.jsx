    ...
    return (
        <div className="">
          ...
          <img 
            ...
            src="rabbi.png"
            className="w-xs md:max-w-sm bg-black rounded-xl bg-opacity-20"
          />
          </div>
          <div
          data-aos="fade-up"
          ...
          data-aos-easing="ease-in-out"
           ...
           className="w-7/12 mx-auto text-center">
            ...
            <p className="py-6 text-xl">
             I am a <span className="text-blue-900">Web Developer</span> and <span className="text-red-800">Video Editor</span>
            </p>
            <a href="Fazle.pdf" download="Fazle Resume"><button className="btn btn-primary">Download Resume</button></a>
            <p 
            data-aos="fade-up"
            data-aos-offset="200"
            data-aos-delay="50"
